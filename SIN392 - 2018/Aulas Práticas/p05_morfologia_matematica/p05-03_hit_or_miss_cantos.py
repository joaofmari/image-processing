...
---------------
Prática 05 - Exemplo 03:
- Transformada hit-or-miss para detecção de cantos.
Referencias:
---------------
...
# Carrega a imagem
# ----------------
imf_1 = misc.imread('../data/dip_3ed/ch09/U.tif')
...
ee4_h = np.array([[0, 1, 0],
                  [1, 1, 0],
                  [0, 0, 0]])

# Elementos estruturantes - MISS
ee1_m = np.array([[1, 1, 0],
                  [1, 0, 0],
                  [0, 0, 0]])
...
ee3_m = np.array([[0, 1, 1],
                  [0, 0, 1],
                  [0, 0, 0]])

ee4_m = np.array([[0, 0, 0],
                  [0, 0, 1],
                  [0, 1, 1]])

# Aplicas as transf. hit-or-miss
...
im_hm = morphology.binary_dilation(im_hm, np.ones([9,9]))
